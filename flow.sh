...
CIRCUIT="./circuits/src/merkle_proof_checker.circom"
CIRCUIT_NAME="merkle_proof_checker"
COMPILED_DIR="$OUTPUT_DIR"
PTAU_DIR="$COMPILED_DIR/ptau"
WITNESS_GEN_DIR="$COMPILED_DIR/merkle_proof_checker_js"
CONTRACTS_DIR="./contracts"

# files
PTAU_PRE="./circuits/src/ptau/powersOfTau28_hez_final_10.ptau"

echo "Compiling signatureCommitment circuit..."
mkdir -p "$COMPILED_DIR"

circom "$CIRCUIT" --r1cs --wasm --output "$COMPILED_DIR"
node "$WITNESS_GEN_DIR/generate_witness.js" "$WITNESS_GEN_DIR/merkle_proof_checker.wasm" "$COMPILED_DIR/input.json" "$COMPILED_DIR/witness.wtns"
